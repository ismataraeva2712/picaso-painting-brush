...
const CheckoutForm = ({ order }) => {
    ...
    useEffect(() => {
        fetch('https://safe-coast-58270.herokuapp.com/create-payment-intent', {
            method: 'POST',
            headers: {
    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                />
                <button className='btn btn-secondary btn-xs' type="submit" disabled={!stripe || !clientSecret}>Pay
                </button>
            </form>
            {
